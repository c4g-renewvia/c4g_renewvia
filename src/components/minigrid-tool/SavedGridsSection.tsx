      ...
      {expanded && (
        <div className='rounded-xl border border-zinc-700/70 bg-white p-6 backdrop-blur-sm dark:bg-zinc-900/50'>
          {loadingSaved ? (
            ...
            <div className='scrollbar-thin scrollbar-thumb-zinc-700 scrollbar-track-zinc-900/50 -mr-2 max-h-96 overflow-y-auto pr-2'>
                ...
                {savedRuns.map((run) => (
                  ...
                  >
                    ...
                    <button
                      ...
                      className='absolute top-3 right-3 rounded-full bg-red-900/60 p-1.5 text-red-300 opacity-70 transition hover:bg-red-900 hover:opacity-100'
